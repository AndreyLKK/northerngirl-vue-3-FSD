<template>
  <div class="bottom-tab-navigator">
    <my-container>
      <div class="bottom-tab-navigator__list">
        <my-navigation
          :navigations="navigations"
          class="bottom-tab-navigator__item"
        ></my-navigation>

        <div class="bottom-tab-navigator__user-wrapper">
          <my-user-menu
            v-if="personStore && personStore.isAuth"
            class="bottom-tab-navigator__user-menu"
            :data="userMenu"
          ></my-user-menu>
          ...
          <my-button
            ...
            class="bottom-tab-navigator__user-button"
            size="m"
            color="primary"
            :text="false"
          >
...
export default {
  components: { MyButton, MyUserMenu, MyNavigation, MyContainer },
  name: "MyBottomTagNavigator",

  data() {
    return {
      navigations: [
        { label: "Каталог", icon: "catalog", count: 0, link: "/catalog" },
...
.bottom-tab-navigator__user-wrapper:deep(.user-menu) {
  display: block;
  margin-left: auto;
}

.bottom-tab-navigator__list {
  display: grid;
  grid-template-columns: 3fr 1fr;
}

.bottom-tab-navigator__user-button {
  width: max-content;
  margin-left: auto;
}

.bottom-tab-navigator__list:deep(.header__list) {
